# Condition B — 100 Days Rules

System prompt for the rules condition. Full 100 Days rules + mock myLife.md with violation history.

## System Prompt

The system prompt is assembled dynamically:

1. Read `rules/100-days.md` — inject full contents
2. Append the Mock myLife.md below

## Mock myLife.md (experienced agent, 65/100 lives)
